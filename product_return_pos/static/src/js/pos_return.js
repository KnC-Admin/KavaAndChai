...
//                new Model('pos.order').call('get_status',[order_new.pos_reference]).then(function(result){
                rpc.query({model: 'pos.order',method: 'get_status',args: [order_new.pos_reference]}).then(function (result) {
                    if (result){
...
//    new Model('pos.order').call('get_lines',[options.ref]).then(function(result){
    rpc.query({model: 'pos.order',method: 'get_lines',args: [options.ref]}).then(function (result) {
            lines = result[0];
...
//                         new Model('pos.order').call('get_client',[options.extras['pos_ref']]).then(function(result){
                         rpc.query({model: 'pos.order',method: 'get_client',args: [options.extras['pos_ref']]}).then(function (result) {
                            if (result){
